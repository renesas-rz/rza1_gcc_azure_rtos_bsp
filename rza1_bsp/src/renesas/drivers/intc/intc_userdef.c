...
/*******************************************************************************
 End of function userdef_intc_regist_int_func
 *******************************************************************************/


/*******************************************************************************
 * Function Name: userdef_intc_unregist_int_func
 * Description  : This function is the user-defined function called by the
...
{
    intc_func_table[int_id] = 0; 
}
/*******************************************************************************
 End of function userdef_intc_unregist_int_func
 *******************************************************************************/
...
/*******************************************************************************
 End of function userdef_intc_undef_id
 *******************************************************************************/
...
{
    if (intc_func_table[int_id] != userdef_intc_dummy_interrupt)
    {
    ...
    {
        /* Call the default interrupt handler, pass the interrupt id as the sense parameter */
        intc_func_table[int_id](int_id);
    }
}
/*******************************************************************************
 End of function userdef_intc_handler_exe
 *******************************************************************************/
...
void userdef_fiq_handler_exe (void)
{
    ...
    uint8_t nmi_status_variable = 0u;

    /* Set the NMI status bit in the user flag */
    nmi_status_variable |= NMI_SET_FLG;
...
/*******************************************************************************
 End of function userdef_fiq_handler_exe
 *******************************************************************************/
...
/*******************************************************************************
 End of function userdef_intc_dummy_interrupt
 *******************************************************************************/
...
uint32_t ulInterruptID;
   ...
   /* Properly handle spurious interrupts */
