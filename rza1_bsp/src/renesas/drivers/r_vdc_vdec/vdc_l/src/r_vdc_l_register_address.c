...
*******************************************************************************/
/**************************************************************************//**
* @file         r_vdc_l_register_address.c
* @version      1.00
* $Rev: 99 $
* $Date:: 2017-04-10 20:56:26 +0900#$
* @brief        RZ/A1L VDC driver register address table
******************************************************************************/
...
#include    "r_vdc_l_register.h"


/******************************************************************************
Macro definitions
******************************************************************************/
#define     VDC_CH0_GR0_CLUT_TBL           (*(uint32_t*)0xFCFF6000u)
#define     VDC_CH0_GR2_CLUT_TBL           (*(uint32_t*)0xFCFF6800u)
#define     VDC_CH0_GR3_CLUT_TBL           (*(uint32_t*)0xFCFF6C00u)
...
{
    &VDC_CH0_GR0_CLUT_TBL,
    &VDC_CH0_GR2_CLUT_TBL,
    &VDC_CH0_GR3_CLUT_TBL
};
