...
#ifndef R_DMAC_INC_R_DMAC_LLD_RZA1L_H_
#define R_DMAC_INC_R_DMAC_LLD_RZA1L_H_
...
#define R_DRV_DMAC_LLD_DRV_NAME           ("LLD RZA1L DMAC")
...
#endif  /* R_DMAC_INC_R_DMAC_LLD_RZA1L_H_ */
