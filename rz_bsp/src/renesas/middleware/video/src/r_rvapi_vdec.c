 ...
 *******************************************************************************/
/**************************************************************************//**
 * File Name :   r_rvapi_vdec.c
 * @file         r_rvapi_vdec.c
 * @version      1.00
 * $Rev: 100 $
 * $Date:: 2017-04-10 21:02:16 +0900#$
 * @brief        RVAPI for VDEC function
 ******************************************************************************/
...
/* YcSep */
#define RADJ_O_LEVEL0_VALUE  ((uint16_t)992u)
#define RADJ_U_LEVEL0_VALUE  ((uint16_t)64u)
#define RADJ_O_LEVEL1_VALUE  ((uint16_t)960u)
#define RADJ_U_LEVEL1_VALUE  ((uint16_t)48u)
#define RADJ_O_LEVEL2_VALUE  ((uint16_t)928u)
#define RADJ_U_LEVEL2_VALUE  ((uint16_t)32u)
 ...
 ******************************************************************************/
static vdec_error_t input(const ana_video_col_sys_t color_system, const vdec_channel_t channel);
static vdec_error_t sync_sep(const ana_video_col_sys_t color_system, const vdec_channel_t channel);
static vdec_error_t yc_sep(const ana_video_col_sys_t color_system, const vdec_channel_t channel);
static vdec_error_t chroma_dec(const ana_video_col_sys_t color_system, const vdec_channel_t channel);
static vdec_error_t digital_clamp(const vdec_channel_t channel);
static vdec_error_t output(const vdec_channel_t channel);

static ana_video_col_sys_t color_system_det(const vdec_q_sync_sep_t * const q_sync_sep,
        const vdec_q_chroma_dec_t * const q_chroma_dec);
static void init_func(const uint32_t user_num);

static const video_recmd_val_t recommended_value[GRPH_COL_SYS_NUM] =
{
{ /* NTSC-3.58 *//* Capturing position setting */SRCLEFT_NTSC_3_58,
SRCTOP_NTSC_3_58,
                                                 SRCHEIGHT_NTSC_3_58, SRCWIDTH_NTSC_3_58,

                                                 /* Horizontal AFC setting */
                                                 HAFCTYP_NTSC_3_58,
                                                 HAFCMAX_NTSC_3_58, HAFCMIN_NTSC_3_58,

                                                 /* Vertical countdown setting */
                                                 VDEC_OFF,
                                                 VDEC_ON, VDEC_VCD_FRQ_59_94HZ, VCDWINDOW_NTSC_3_58,
                                                 VCDOFFSET_NTSC_3_58,

                                                 /* BCO setting */
                                                 VDEC_COL_SYS_NTSC,
                                                 VDEC_ON, VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_OFF,
                                                 ...
                                                 /* Y/C separation setting */
                                                 K15_NTSC_3_58,
                                                 K13_NTSC_3_58, K11_NTSC_3_58, K16_NTSC_3_58, K14_NTSC_3_58,
                                                 K12_NTSC_3_58,
                                                 K22A_NTSC_3_58,
                                                 K21A_NTSC_3_58,
                                                 K22B_NTSC_3_58, K21B_NTSC_3_58, K23B_NTSC_3_58,
                                                 K23A_NTSC_3_58,
                                                 K24_NTSC_3_58, VDEC_ON, VDEC_FILMIX_RATIO_75, VDEC_FILMIX_RATIO_75,
                                                 VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_25,
                                                 VDEC_2DFIL_MDSEL_CASCADE, VDEC_2D_FIL_SEL_17TAP },
  {
  /* NTSC-4.43 */
  /* Capturing position setting */
  SRCLEFT_NTSC_4_43,
    SRCTOP_NTSC_4_43, SRCHEIGHT_NTSC_4_43, SRCWIDTH_NTSC_4_43,

    /* Horizontal AFC setting */
    HAFCTYP_NTSC_4_43,
    HAFCMAX_NTSC_4_43, HAFCMIN_NTSC_4_43,

    /* Vertical countdown setting */
    VDEC_ON,
    VDEC_OFF, VDEC_VCD_FRQ_50HZ, VCDWINDOW_NTSC_4_43, VCDOFFSET_NTSC_4_43,

    /* BCO setting */
    VDEC_COL_SYS_NTSC,
    VDEC_OFF, VDEC_ON, VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_OFF,
    ...
    /* Y/C separation setting */
    K15_NTSC_4_43,
    K13_NTSC_4_43, K11_NTSC_4_43, K16_NTSC_4_43, K14_NTSC_4_43, K12_NTSC_4_43,
    K22A_NTSC_4_43,
    K21A_NTSC_4_43, K22B_NTSC_4_43, K21B_NTSC_4_43, K23B_NTSC_4_43, K23A_NTSC_4_43, K24_NTSC_4_43, VDEC_ON,
    VDEC_FILMIX_RATIO_75, VDEC_FILMIX_RATIO_75, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_25,
    VDEC_2DFIL_MDSEL_CASCADE, VDEC_2D_FIL_SEL_17TAP },
  {
  /* PAL-4.43 */
  /* Capturing position setting */
  SRCLEFT_PAL_4_43,
    SRCTOP_PAL_4_43, SRCHEIGHT_PAL_4_43, SRCWIDTH_PAL_4_43,

    /* Horizontal AFC setting */
    HAFCTYP_PAL_4_43,
    HAFCMAX_PAL_4_43, HAFCMIN_PAL_4_43,

    /* Vertical countdown setting */
    VDEC_ON,
    VDEC_OFF, VDEC_VCD_FRQ_50HZ, VCDWINDOW_PAL_4_43, VCDOFFSET_PAL_4_43,

    /* BCO setting */
    VDEC_COL_SYS_PAL,
    VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_ON, VDEC_OFF,
    ...
    /* Y/C separation setting */
    K15_PAL_4_43,
    K13_PAL_4_43, K11_PAL_4_43, K16_PAL_4_43, K14_PAL_4_43, K12_PAL_4_43,
    K22A_PAL_4_43,
    K21A_PAL_4_43, K22B_PAL_4_43, K21B_PAL_4_43, K23B_PAL_4_43, K23A_PAL_4_43, K24_PAL_4_43, VDEC_OFF,
    VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0,
    VDEC_2DFIL_MDSEL_BYPASS, VDEC_2D_FIL_SEL_17TAP },
  {
  /* PAL-M */
  /* Capturing position setting */
  SRCLEFT_PAL_M,
    SRCTOP_PAL_M, SRCHEIGHT_PAL_M, SRCWIDTH_PAL_M,

    /* Horizontal AFC setting */
    HAFCTYP_PAL_M,
    HAFCMAX_PAL_M, HAFCMIN_PAL_M,

    /* Vertical countdown setting */
    VDEC_OFF,
    VDEC_ON, VDEC_VCD_FRQ_59_94HZ, VCDWINDOW_PAL_M, VCDOFFSET_PAL_M,

    /* BCO setting */
    VDEC_COL_SYS_PAL,
    VDEC_OFF, VDEC_OFF, VDEC_ON, VDEC_OFF, VDEC_OFF, VDEC_OFF,
    ...
    /* Y/C separation setting */
    K15_PAL_M,
    K13_PAL_M, K11_PAL_M, K16_PAL_M, K14_PAL_M, K12_PAL_M,
    K22A_PAL_M,
    K21A_PAL_M, K22B_PAL_M, K21B_PAL_M, K23B_PAL_M, K23A_PAL_M, K24_PAL_M, VDEC_OFF, VDEC_FILMIX_RATIO_0,
    VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_2DFIL_MDSEL_BYPASS,
    VDEC_2D_FIL_SEL_17TAP },
  {
  /* PAL-N */
  /* Capturing position setting */
  SRCLEFT_PAL_N,
    SRCTOP_PAL_N, SRCHEIGHT_PAL_N, SRCWIDTH_PAL_N,

    /* Horizontal AFC setting */
    HAFCTYP_PAL_N,
    HAFCMAX_PAL_N, HAFCMIN_PAL_N,

    /* Vertical countdown setting */
    VDEC_ON,
    VDEC_OFF, VDEC_VCD_FRQ_50HZ, VCDWINDOW_PAL_N, VCDOFFSET_PAL_N,

    /* BCO setting */
    VDEC_COL_SYS_PAL,
    VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_ON, VDEC_OFF, VDEC_OFF,
    ...
    /* Y/C separation setting */
    K15_PAL_N,
    K13_PAL_N, K11_PAL_N, K16_PAL_N, K14_PAL_N, K12_PAL_N,
    K22A_PAL_N,
    K21A_PAL_N, K22B_PAL_N, K21B_PAL_N, K23B_PAL_N, K23A_PAL_N, K24_PAL_N, VDEC_OFF, VDEC_FILMIX_RATIO_0,
    VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_2DFIL_MDSEL_BYPASS,
    VDEC_2D_FIL_SEL_17TAP },
  {
  /* SECAM */
  /* Capturing position setting */
  SRCLEFT_SECAM,
    SRCTOP_SECAM, SRCHEIGHT_SECAM, SRCWIDTH_SECAM,

    /* Horizontal AFC setting */
    HAFCTYP_SECAM,
    HAFCMAX_SECAM, HAFCMIN_SECAM,

    /* Vertical countdown setting */
    VDEC_ON,
    VDEC_OFF, VDEC_VCD_FRQ_50HZ, VCDWINDOW_SECAM, VCDOFFSET_SECAM,

    /* BCO setting */
    VDEC_COL_SYS_SECAM,
    VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_OFF, VDEC_ON,
    ...
    /* Y/C separation setting */
    K15_SECAM,
    K13_SECAM, K11_SECAM, K16_SECAM, K14_SECAM, K12_SECAM,
    K22A_SECAM,
    K21A_SECAM, K22B_SECAM, K21B_SECAM, K23B_SECAM, K23A_SECAM, K24_SECAM, VDEC_ON, VDEC_FILMIX_RATIO_75,
    VDEC_FILMIX_RATIO_75, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_2DFIL_MDSEL_CASCADE,
    VDEC_2D_FIL_SEL_17TAP },
  {
  /* NTSC-4.43 (60Hz) */
  /* Capturing position setting */
  SRCLEFT_NTSC_443_60,
    SRCTOP_NTSC_443_60, SRCHEIGHT_NTSC_443_60, SRCWIDTH_NTSC_443_60,

    /* Horizontal AFC setting */
    HAFCTYP_NTSC_443_60,
    HAFCMAX_NTSC_443_60, HAFCMIN_NTSC_443_60,

    /* Vertical countdown setting */
    VDEC_OFF,
    VDEC_ON, VDEC_VCD_FRQ_59_94HZ, VCDWINDOW_NTSC_443_60, VCDOFFSET_NTSC_443_60,
    ...
    /* Y/C separation setting */
    K15_NTSC_443_60,
    K13_NTSC_443_60, K11_NTSC_443_60, K16_NTSC_443_60, K14_NTSC_443_60, K12_NTSC_443_60,
    K22A_NTSC_443_60,
    K21A_NTSC_443_60, K22B_NTSC_443_60, K21B_NTSC_443_60, K23B_NTSC_443_60, K23A_NTSC_443_60,
    K24_NTSC_443_60,
    VDEC_ON, VDEC_FILMIX_RATIO_75, VDEC_FILMIX_RATIO_75, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_25,
    VDEC_2DFIL_MDSEL_CASCADE, VDEC_2D_FIL_SEL_17TAP },
  {
  /* PAL-60 */
  /* Capturing position setting */
  SRCLEFT_PAL_60,
    SRCTOP_PAL_60, SRCHEIGHT_PAL_60, SRCWIDTH_PAL_60,

    /* Horizontal AFC setting */
    HAFCTYP_PAL_60,
    HAFCMAX_PAL_60, HAFCMIN_PAL_60,

    /* Vertical countdown setting */
    VDEC_OFF,
    VDEC_ON, VDEC_VCD_FRQ_59_94HZ, VCDWINDOW_PAL_60, VCDOFFSET_PAL_60,
    ...
    /* Y/C separation setting */
    K15_PAL_60,
    K13_PAL_60, K11_PAL_60, K16_PAL_60, K14_PAL_60, K12_PAL_60,
    K22A_PAL_60,
    K21A_PAL_60, K22B_PAL_60, K21B_PAL_60, K23B_PAL_60, K23A_PAL_60, K24_PAL_60, VDEC_OFF, VDEC_FILMIX_RATIO_0,
    VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_FILMIX_RATIO_0, VDEC_2DFIL_MDSEL_BYPASS,
    VDEC_2D_FIL_SEL_17TAP } };
...
{
{ (uint16_t) 24u, (uint16_t) 44u, (uint16_t) 20u, (uint16_t) (0x1000u | 52u), (uint16_t) (0x1000u | 128u), (uint16_t) (
        0x1000u | 128u),
  (uint16_t) (0x1000u | 12u), (uint16_t) 132u, (uint16_t) 200u } };

/* Two-Dimensional Cascade Broadband (SECAM-DR) Filter TAP Coefficient */
static const vdec_chrfil_tap_t wa_secam =
{
{ (uint16_t) (0x1000u | 20u), (uint16_t) 24u, (uint16_t) 64u, (uint16_t) 40u, (uint16_t) (0x1000u | 76u), (uint16_t) (
        0x1000u | 164u),
  (uint16_t) (0x1000u | 84u), (uint16_t) 108u, (uint16_t) 216u } };

/* Two-Dimensional Cascade Broadband (SECAM-DB) Filter TAP Coefficient */
static const vdec_chrfil_tap_t wb_secam =
{
{ (uint16_t) (0x1000u | 12u), (uint16_t) 40u, (uint16_t) 60u, (uint16_t) 12u, (uint16_t) (0x1000u | 104u), (uint16_t) (
        0x1000u | 156u),
  (uint16_t) (0x1000u | 64u), (uint16_t) 120u, (uint16_t) 208u } };
...
/**************************************************************************//**
 * Function Name : R_RVAPI_AnalogVideDecodeDVDEC
...
ana_video_col_sys_t R_RVAPI_AnalogVideDecodeDVDEC(const vdec_channel_t channel, const vdec_adc_vinsel_t adc_vinsel)
{
    ...
    ana_video_col_sys_t color_system;
    ...
    if (VDEC_OK == error)
    {
        color_system = color_system_det (&q_sync_sep, &q_chroma_dec);
    }

    if (GRPH_COL_SYS_UNKNOWN != color_system)
    {
        /* Input */
        if (VDEC_OK == error)
        {
            error = input (color_system, channel);
        }
        if (VDEC_OK == error)
        {
            /* Sync separation */
            error = sync_sep (color_system, channel);
        }
        if (VDEC_OK == error)
        {
            /* Y/C separation */
            error = yc_sep (color_system, channel);
        }
        if (VDEC_OK == error)
        {
            /* Chroma decoding */
            error = chroma_dec (color_system, channel);
        }
        if (VDEC_OK == error)
        {
            /* Digital clamp */
            error = digital_clamp (channel);
        }
        if (VDEC_OK == error)
        {
            /* Output */
    ...
    return color_system;
} /* End of function R_RVAPI_AnalogVideDecodeDVDEC() */

/**************************************************************************//**
 * Function Name : color_system_det
 * @brief       Color system detection
 * @param[in]   q_sync_sep      : Pointer to the place where the sync separation parameters are stored.
 * @param[in]   q_chroma_dec    : Pointer to the place where the chroma decoding parameters are stored.
 * @retval      Detected color system
 *****************************************************************************/
static ana_video_col_sys_t color_system_det(const vdec_q_sync_sep_t * const q_sync_sep,
        const vdec_q_chroma_dec_t * const q_chroma_dec)
{
    ...
    if (VDEC_NO == q_sync_sep->nosignal_)
    {
        /* Do Nothing */
    }
    else
    {
        switch (q_chroma_dec->colorsys)
        {
            ...
            case VDEC_COL_SYS_NTSC:
                ...
                if (VDEC_FSCMD_3_58 == q_chroma_dec->fscmode)
                {
                    /* NTSC-3.58 */
                ...
                {
                    /* NTSC-4.43 or NTSC-4.43 (60Hz) */
                    if (VDEC_FVMD_50HZ == q_sync_sep->fvmode)
                    {
            ...
            case VDEC_COL_SYS_PAL:
                ...
                else
                {
                    ...
                    if (VDEC_FVMD_50HZ == q_sync_sep->fvmode)
                    {
                        color_system = GRPH_COL_SYS_PAL_443;
                    }
                    else
                    {
                        color_system = GRPH_COL_SYS_PAL_60;
                    }
                }
            break;
    ...
    return color_system;
} /* End of function color_system_det() */

/**************************************************************************//**
 * Function Name : init_func
 * @brief       User-defined function (Standby control setting)
 * @param[in]   user_num            :
 * @retval      None                :
 *****************************************************************************/
static void init_func(const uint32_t user_num)
 ...
 * @param[in]   channel         : Channel for VDEC
 * @retval      VDEC driver error code
 *****************************************************************************/
static vdec_error_t input(const ana_video_col_sys_t color_system, const vdec_channel_t channel)
{
    vdec_error_t error;
    vdec_active_period_t param;
    const video_recmd_val_t * precommend_val_tbl;

    if ((GRPH_COL_SYS_NUM > color_system) && (0 <= color_system))
    {
        precommend_val_tbl = &recommended_value[color_system];

        param.srcleft = precommend_val_tbl->srcleft; /* Left end of input video signal capturing area */
        param.srctop = precommend_val_tbl->srctop; /* Top end of input video signal capturing area */
        param.srcheight = precommend_val_tbl->srcheight; /* Height of input video signal capturing area */
        param.srcwidth = precommend_val_tbl->srcwidth; /* Width of input video signal capturing area */
...
static vdec_error_t sync_sep(const ana_video_col_sys_t color_system, const vdec_channel_t channel)
{
    ...
    if ((GRPH_COL_SYS_NUM > color_system) && (0 <= color_system))
    {
        ...
        horizontal_afc_tmp.hafctyp = precommend_val_tbl->hafctyp; /* Horizontal AFC center oscillation frequency */
        ...
        horizontal_afc_tmp.hafcmax = precommend_val_tbl->hafcmax; /* Maximum oscillation frequency of horizontal AFC */
        ...
        horizontal_afc_tmp.hafcmin = precommend_val_tbl->hafcmin; /* Min oscillation frequency of horizontal AFC */
        ...
        /* Vertical countdown */
        vcount_down_tmp.novcd50_ = precommend_val_tbl->novcd50_; /* Vertical countdown 50-Hz oscillation mode */
        vcount_down_tmp.novcd60_ = precommend_val_tbl->novcd60_; /* Vertical countdown 60-Hz (59.94-Hz)
         oscillation mode */
        vcount_down_tmp.vcddefault = precommend_val_tbl->vcddefault; /* Vertical countdown center oscillation frequency */
        vcount_down_tmp.vcdwindow = precommend_val_tbl->vcdwindow; /* Vertical countdown sync area */
        vcount_down_tmp.vcdoffset = precommend_val_tbl->vcdoffset; /* Vertical countdown minimum oscillation frequency */
        ...
        agc_tmp.agclevel = precommend_val_tbl->agclevel;/* Sync signal reference amplitude */
    ...
    return error;
} /* End of function sync_sep() */

/**************************************************************************//**
 * Function Name : yc_sep
...
static vdec_error_t yc_sep(const ana_video_col_sys_t color_system, const vdec_channel_t channel)
{
    ...
    if ((GRPH_COL_SYS_NUM > color_system) && (0 <= color_system))
    {
        ...
        yc_sep_ctrl_tmp.k15 = precommend_val_tbl->k15; /* K15 */
        yc_sep_ctrl_tmp.k13 = precommend_val_tbl->k13; /* K13 */
        yc_sep_ctrl_tmp.k11 = precommend_val_tbl->k11; /* K11 */
        yc_sep_ctrl_tmp.k16 = precommend_val_tbl->k16; /* K16 */
        yc_sep_ctrl_tmp.k14 = precommend_val_tbl->k14; /* K14 */
        yc_sep_ctrl_tmp.k12 = precommend_val_tbl->k12; /* K12 */
        yc_sep_ctrl_tmp.k22a = precommend_val_tbl->k22a; /* K22A */
        yc_sep_ctrl_tmp.k21a = precommend_val_tbl->k21a; /* K21A */
        yc_sep_ctrl_tmp.k22b = precommend_val_tbl->k22b; /* K22B */
        yc_sep_ctrl_tmp.k21b = precommend_val_tbl->k21b; /* K21B */
        yc_sep_ctrl_tmp.k23b = precommend_val_tbl->k23b; /* K23B */
        yc_sep_ctrl_tmp.k23a = precommend_val_tbl->k23a; /* K23A */
        yc_sep_ctrl_tmp.k24 = precommend_val_tbl->k24; /* K24 */
        ...
        yc_sep_ctrl_tmp.det2_on = precommend_val_tbl->det2_on; /* Two-dimensional filter mixing select */
        yc_sep_ctrl_tmp.hsel_mix_y = precommend_val_tbl->hsel_mix_y; /* Mixing ratio of signal after passing
         horizontal filter to signal after passing
         former-stage horizontal filter */
        yc_sep_ctrl_tmp.vsel_mix_y = precommend_val_tbl->vsel_mix_y; /* Mixing ratio of signal after passing
         vertical filter to signal after passing
         former-stage horizontal/vertical filter */
        yc_sep_ctrl_tmp.hvsel_mix_y = precommend_val_tbl->hvsel_mix_y; /* Mixing ratio of signal after passing
        ...
        yc_sep_ctrl_tmp.det2_mix_c = precommend_val_tbl->det2_mix_c; /* Mixing ratio of c signal after passing
         horizontal/vertical adaptive filter
         to signal after passing correlation detection
         filter */
        yc_sep_ctrl_tmp.det2_mix_y = precommend_val_tbl->det2_mix_y; /* Mixing ratio of c signal for y generation after
         passing horizontal/vertical adaptive filter to
         signal after passing correlation */
        yc_sep_ctrl_tmp.fil2_mode_2d = precommend_val_tbl->fil2_mode_2d; /* Two-dimensional cascade/TAKE-OFF
         filter mode select */
        yc_sep_ctrl_tmp.fil2_narrow_2d = precommend_val_tbl->fil2_narrow_2d;/* Two-dimensional cascade filter select */
        ...
        if (((GRPH_COL_SYS_NTSC_358 == color_system) || (GRPH_COL_SYS_NTSC_443 == color_system))
                || (GRPH_COL_SYS_NTSC_443_60 == color_system))
        {
            param.fil2_2d_wa = &wana_ntsc;
            param.fil2_2d_na = &wana_ntsc;
        }
        else if (GRPH_COL_SYS_SECAM == color_system)
        {
    ...
    return error;
} /* End of function yc_sep() */

/**************************************************************************//**
 * Function Name : chroma_dec
...
static vdec_error_t chroma_dec(const ana_video_col_sys_t color_system, const vdec_channel_t channel)
{
    ...
    if ((GRPH_COL_SYS_NUM > color_system) && (0 <= color_system))
    {
        ...
        chrmdec_ctrl_tmp.defaultsys = precommend_val_tbl->defaultsys; /* Default color system */
        chrmdec_ctrl_tmp.nontsc358_ = precommend_val_tbl->nontsc358_; /* NTSC-M detection control */
        chrmdec_ctrl_tmp.nontsc443_ = precommend_val_tbl->nontsc443_; /* NTSC-4.43 detection control */
        chrmdec_ctrl_tmp.nopalm_ = precommend_val_tbl->nopalm_; /* PAL-M detection control */
        chrmdec_ctrl_tmp.nopaln_ = precommend_val_tbl->nopaln_; /* PAL-N detection control */
        chrmdec_ctrl_tmp.nopal443_ = precommend_val_tbl->nopal443_; /* PAL-B, G, H, I, D detection control */
        chrmdec_ctrl_tmp.nosecam_ = precommend_val_tbl->nosecam_; /* SECAM detection control */
        ...
        acc_tmp.acclevel = precommend_val_tbl->acclevel;/* ACC reference color burst amplitude */
    ...
    return error;
} /* End of function chroma_dec() */

/**************************************************************************//**
 * Function Name : digital_clamp
