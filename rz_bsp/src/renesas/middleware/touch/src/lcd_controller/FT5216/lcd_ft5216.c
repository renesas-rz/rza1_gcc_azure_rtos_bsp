...
/***********************************************************************************
 Global Variables
 ***********************************************************************************/
psemaphore_t sLcdSemIdTsk;
psemaphore_t sLcdSemIdAcc;
...
int_t LCD_Ft5216_Open (const uint32_t unIrqLv, int16_t nTskPri, uint32_t unTskStk)
{
    ...
    riic_clock.frequency = RIIC_FREQUENCY_400KHZ;
    ...
    if (nRet >= 0)
    {
        nRet = LCD_Ft5216_Int_Open(unIrqLv);
        if (nRet < 0)
        {
            R_OS_DeleteSemaphore( sLcdSemIdAcc);
...
/**************************************************************************//**
 * Function Name: LCD_Ft5216_Close
...
/**************************************************************************//**
 * Function Name: LCD_Ft5216_WriteCmd
...
void LCD_Ft5216_Reset ( void ) {
	...
	i2c_read.device_address = (uint8_t)RZA1H_APP_I2C_FT5216;
	i2c_read.sub_address = 0;
	i2c_read.number_of_bytes = 2;
	i2c_read.p_data_buffer = uData;

	i2c_write.device_address = (uint8_t)RZA1H_APP_I2C_FT5216;
	i2c_write.sub_address = 0x08;
	i2c_write.number_of_bytes = 2;
	i2c_write.p_data_buffer = (uint8_t *) &uData;
	/* Initial Read to reset the touch */
	control(hi2c0, CTL_RIIC_READ_NEXT, &i2c_read);

	uData[0]= 0xBF;
	control(hi2c0, CTL_RIIC_WRITE, &i2c_write);
...
/**************************************************************************//**
 * Function Name: LCD_Ft5216_ReadCmd
...
uint8_t LCD_Ft5216_ReadCmd (const uint16_t unDevAddr, uint8_t *puData, const uint32_t unSize)
{
    ...
    nRet = control(hi2c0, CTL_RIIC_READ_NEXT, &i2c_read);

    return (uint8_t)nRet;
}

/**************************************************************************//**
 * Function Name: LCD_Ft5216_EventEntry
...
/**************************************************************************//**
 * Function Name: LCD_Ft5216_EventErase
...
/**************************************************************************//**
 * Function Name: LCD_Ft5216_StartInt
...
int_t LCD_Ft5216_StartInt (const LcdEvt_EntryType eType)
{
    ...
    nRet = LCD_Ft5216_Int_Start();

    return nRet;
}

/**************************************************************************//**
 * Function Name: LCD_Ft5216_GetEventTable
...
/**************************************************************************//**
 * Function Name: LCD_Ft5216_SendEvtMsg
...
/**************************************************************************//**
 * Function Name: LCD_Ft5216_WaitEvtMsg
...
/**************************************************************************//**
 * Function Name: LCD_Ft5216_ClearEvtMsg
