...
/***********************************************************************************
 Global Variables
***********************************************************************************/
extern semaphore_t   sLcdSemIdAcc;
...
/**
 * @brief           Opens the communication environment with the Ft5216.
...
/**
 * @brief       Closes the communication environment with the Ft5216.
 * @retval      NONE
*/
int_t        LCD_Ft5x06_Close( void );

/**
 * @brief       Sends data to the Ft5216 via the RIIC DeviceController ch1.
...
/**
 * @brief       Reads data from the Ft5216 via the RIIC DeviceController ch1.
 * @param[in]       unDevAddr LCD Device Address
...
/**
 * @brief       Registers in the event management structure a call-back function linked to an interrupt from the Ft5216.\n
