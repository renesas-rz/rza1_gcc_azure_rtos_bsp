...
#define MTU2_TMDR_2_MD                          (0x0Fu)

#define MTU2_TIOR_2_IOA                         (0x0Fu)
#define MTU2_TIOR_2_IOB                         (0xF0u)

#define MTU2_TIER_2_TGIEA                       (0x01u)
#define MTU2_TIER_2_TGIEB                       (0x02u)
#define MTU2_TIER_2_TCIEV                       (0x10u)
#define MTU2_TIER_2_TCIEU                       (0x20u)
#define MTU2_TIER_2_TTGE                        (0x80u)

#define MTU2_TSR_2_TGFA                         (0x01u)
#define MTU2_TSR_2_TGFB                         (0x02u)
#define MTU2_TSR_2_TCFV                         (0x10u)
#define MTU2_TSR_2_TCFU                         (0x20u)
#define MTU2_TSR_2_TCFD                         (0x80u)

#define MTU2_TCNT_2_D                           (0xFFFFu)

#define MTU2_TGRA_2_D                           (0xFFFFu)

#define MTU2_TGRB_2_D                           (0xFFFFu)

#define MTU2_TCR_3_TPSC                         (0x07u)
#define MTU2_TCR_3_CKEG                         (0x18u)
#define MTU2_TCR_3_CCLR                         (0xE0u)

#define MTU2_TCR_4_TPSC                         (0x07u)
#define MTU2_TCR_4_CKEG                         (0x18u)
#define MTU2_TCR_4_CCLR                         (0xE0u)

#define MTU2_TMDR_3_MD                          (0x0Fu)
#define MTU2_TMDR_3_BFA                         (0x10u)
#define MTU2_TMDR_3_BFB                         (0x20u)

#define MTU2_TMDR_4_MD                          (0x0Fu)
...
#define MTU2_TIER_3_TGIEA                       (0x01u)
#define MTU2_TIER_3_TGIEB                       (0x02u)
#define MTU2_TIER_3_TGIEC                       (0x04u)
#define MTU2_TIER_3_TGIED                       (0x08u)
#define MTU2_TIER_3_TCIEV                       (0x10u)
#define MTU2_TIER_3_TTGE                        (0x80u)

#define MTU2_TIER_4_TGIEA                       (0x01u)
#define MTU2_TIER_4_TGIEB                       (0x02u)
#define MTU2_TIER_4_TGIEC                       (0x04u)
#define MTU2_TIER_4_TGIED                       (0x08u)
#define MTU2_TIER_4_TCIEV                       (0x10u)
#define MTU2_TIER_4_TTGE2                       (0x40u)
#define MTU2_TIER_4_TTGE                        (0x80u)
...
#define MTU2_TCNT_3_D                           (0xFFFFu)

#define MTU2_TCNT_4_D                           (0xFFFFu)

#define MTU2_TCDR_D                             (0xFFFFu)

#define MTU2_TDDR_D                             (0xFFFFu)

#define MTU2_TGRA_3_D                           (0xFFFFu)

#define MTU2_TGRB_3_D                           (0xFFFFu)

#define MTU2_TGRA_4_D                           (0xFFFFu)

#define MTU2_TGRB_4_D                           (0xFFFFu)
...
#define MTU2_TSR_3_TGFA                         (0x01u)
#define MTU2_TSR_3_TGFB                         (0x02u)
#define MTU2_TSR_3_TGFC                         (0x04u)
#define MTU2_TSR_3_TGFD                         (0x08u)
#define MTU2_TSR_3_TCFV                         (0x10u)
#define MTU2_TSR_3_TCFD                         (0x80u)

#define MTU2_TSR_4_TGFA                         (0x01u)
#define MTU2_TSR_4_TGFB                         (0x02u)
#define MTU2_TSR_4_TGFC                         (0x04u)
#define MTU2_TSR_4_TGFD                         (0x08u)
#define MTU2_TSR_4_TCFV                         (0x10u)
#define MTU2_TSR_4_TCFD                         (0x80u)

#define MTU2_TITCR__4VCOR                       (0x07u)
#define MTU2_TITCR_T4VEN                        (0x08u)
#define MTU2_TITCR__3ACOR                       (0x70u)
#define MTU2_TITCR_T3AEN                        (0x80u)

#define MTU2_TITCNT__4VCNT                      (0x07u)
#define MTU2_TITCNT__3ACNT                      (0x70u)
...
#define MTU2_TCR_0_TPSC                         (0x07u)
#define MTU2_TCR_0_CKEG                         (0x18u)
#define MTU2_TCR_0_CCLR                         (0xE0u)

#define MTU2_TMDR_0_MD                          (0x0Fu)
...
#define MTU2_TIER_0_TGIEA                       (0x01u)
#define MTU2_TIER_0_TGIEB                       (0x02u)
#define MTU2_TIER_0_TGIEC                       (0x04u)
#define MTU2_TIER_0_TGIED                       (0x08u)
#define MTU2_TIER_0_TCIEV                       (0x10u)
#define MTU2_TIER_0_TTGE                        (0x80u)

#define MTU2_TSR_0_TGFA                         (0x01u)
#define MTU2_TSR_0_TGFB                         (0x02u)
#define MTU2_TSR_0_TGFC                         (0x04u)
#define MTU2_TSR_0_TGFD                         (0x08u)
#define MTU2_TSR_0_TCFV                         (0x10u)

#define MTU2_TCNT_0_D                           (0xFFFFu)

#define MTU2_TGRA_0_D                           (0xFFFFu)

#define MTU2_TGRB_0_D                           (0xFFFFu)
...
#define MTU2_TCR_1_TPSC                         (0x07u)
#define MTU2_TCR_1_CKEG                         (0x18u)
#define MTU2_TCR_1_CCLR                         (0x60u)

#define MTU2_TMDR_1_MD                          (0x0Fu)

#define MTU2_TIOR_1_IOA                         (0x0Fu)
#define MTU2_TIOR_1_IOB                         (0xF0u)

#define MTU2_TIER_1_TGIEA                       (0x01u)
#define MTU2_TIER_1_TGIEB                       (0x02u)
#define MTU2_TIER_1_TCIEV                       (0x10u)
#define MTU2_TIER_1_TCIEU                       (0x20u)
#define MTU2_TIER_1_TTGE                        (0x80u)

#define MTU2_TSR_1_TGFA                         (0x01u)
#define MTU2_TSR_1_TGFB                         (0x02u)
#define MTU2_TSR_1_TCFV                         (0x10u)
#define MTU2_TSR_1_TCFU                         (0x20u)
#define MTU2_TSR_1_TCFD                         (0x80u)

#define MTU2_TCNT_1_D                           (0xFFFFu)

#define MTU2_TGRA_1_D                           (0xFFFFu)

#define MTU2_TGRB_1_D                           (0xFFFFu)
...
#define MTU2_TMDR_2_MD_SHIFT                    (0u)

#define MTU2_TIOR_2_IOA_SHIFT                   (0u)
#define MTU2_TIOR_2_IOB_SHIFT                   (4u)

#define MTU2_TIER_2_TGIEA_SHIFT                 (0u)
#define MTU2_TIER_2_TGIEB_SHIFT                 (1u)
#define MTU2_TIER_2_TCIEV_SHIFT                 (4u)
#define MTU2_TIER_2_TCIEU_SHIFT                 (5u)
#define MTU2_TIER_2_TTGE_SHIFT                  (7u)

#define MTU2_TSR_2_TGFA_SHIFT                   (0u)
#define MTU2_TSR_2_TGFB_SHIFT                   (1u)
#define MTU2_TSR_2_TCFV_SHIFT                   (4u)
#define MTU2_TSR_2_TCFU_SHIFT                   (5u)
#define MTU2_TSR_2_TCFD_SHIFT                   (7u)

#define MTU2_TCNT_2_D_SHIFT                     (0u)

#define MTU2_TGRA_2_D_SHIFT                     (0u)

#define MTU2_TGRB_2_D_SHIFT                     (0u)

#define MTU2_TCR_3_TPSC_SHIFT                   (0u)
#define MTU2_TCR_3_CKEG_SHIFT                   (3u)
#define MTU2_TCR_3_CCLR_SHIFT                   (5u)

#define MTU2_TCR_4_TPSC_SHIFT                   (0u)
#define MTU2_TCR_4_CKEG_SHIFT                   (3u)
#define MTU2_TCR_4_CCLR_SHIFT                   (5u)

#define MTU2_TMDR_3_MD_SHIFT                    (0u)
#define MTU2_TMDR_3_BFA_SHIFT                   (4u)
#define MTU2_TMDR_3_BFB_SHIFT                   (5u)

#define MTU2_TMDR_4_MD_SHIFT                    (0u)
...
#define MTU2_TIER_3_TGIEA_SHIFT                 (0u)
#define MTU2_TIER_3_TGIEB_SHIFT                 (1u)
#define MTU2_TIER_3_TGIEC_SHIFT                 (2u)
#define MTU2_TIER_3_TGIED_SHIFT                 (3u)
#define MTU2_TIER_3_TCIEV_SHIFT                 (4u)
#define MTU2_TIER_3_TTGE_SHIFT                  (7u)

#define MTU2_TIER_4_TGIEA_SHIFT                 (0u)
#define MTU2_TIER_4_TGIEB_SHIFT                 (1u)
#define MTU2_TIER_4_TGIEC_SHIFT                 (2u)
#define MTU2_TIER_4_TGIED_SHIFT                 (3u)
#define MTU2_TIER_4_TCIEV_SHIFT                 (4u)
#define MTU2_TIER_4_TTGE2_SHIFT                 (6u)
#define MTU2_TIER_4_TTGE_SHIFT                  (7u)
...
#define MTU2_TCNT_3_D_SHIFT                     (0u)

#define MTU2_TCNT_4_D_SHIFT                     (0u)

#define MTU2_TCDR_D_SHIFT                       (0u)

#define MTU2_TDDR_D_SHIFT                       (0u)

#define MTU2_TGRA_3_D_SHIFT                     (0u)

#define MTU2_TGRB_3_D_SHIFT                     (0u)

#define MTU2_TGRA_4_D_SHIFT                     (0u)

#define MTU2_TGRB_4_D_SHIFT                     (0u)
...
#define MTU2_TSR_3_TGFA_SHIFT                   (0u)
#define MTU2_TSR_3_TGFB_SHIFT                   (1u)
#define MTU2_TSR_3_TGFC_SHIFT                   (2u)
#define MTU2_TSR_3_TGFD_SHIFT                   (3u)
#define MTU2_TSR_3_TCFV_SHIFT                   (4u)
#define MTU2_TSR_3_TCFD_SHIFT                   (7u)

#define MTU2_TSR_4_TGFA_SHIFT                   (0u)
#define MTU2_TSR_4_TGFB_SHIFT                   (1u)
#define MTU2_TSR_4_TGFC_SHIFT                   (2u)
#define MTU2_TSR_4_TGFD_SHIFT                   (3u)
#define MTU2_TSR_4_TCFV_SHIFT                   (4u)
#define MTU2_TSR_4_TCFD_SHIFT                   (7u)

#define MTU2_TITCR__4VCOR_SHIFT                 (0u)
#define MTU2_TITCR_T4VEN_SHIFT                  (3u)
#define MTU2_TITCR__3ACOR_SHIFT                 (4u)
#define MTU2_TITCR_T3AEN_SHIFT                  (7u)

#define MTU2_TITCNT__4VCNT_SHIFT                (0u)
#define MTU2_TITCNT__3ACNT_SHIFT                (4u)
...
#define MTU2_TCR_0_TPSC_SHIFT                   (0u)
#define MTU2_TCR_0_CKEG_SHIFT                   (3u)
#define MTU2_TCR_0_CCLR_SHIFT                   (5u)

#define MTU2_TMDR_0_MD_SHIFT                    (0u)
...
#define MTU2_TIER_0_TGIEA_SHIFT                 (0u)
#define MTU2_TIER_0_TGIEB_SHIFT                 (1u)
#define MTU2_TIER_0_TGIEC_SHIFT                 (2u)
#define MTU2_TIER_0_TGIED_SHIFT                 (3u)
#define MTU2_TIER_0_TCIEV_SHIFT                 (4u)
#define MTU2_TIER_0_TTGE_SHIFT                  (7u)

#define MTU2_TSR_0_TGFA_SHIFT                   (0u)
#define MTU2_TSR_0_TGFB_SHIFT                   (1u)
#define MTU2_TSR_0_TGFC_SHIFT                   (2u)
#define MTU2_TSR_0_TGFD_SHIFT                   (3u)
#define MTU2_TSR_0_TCFV_SHIFT                   (4u)

#define MTU2_TCNT_0_D_SHIFT                     (0u)

#define MTU2_TGRA_0_D_SHIFT                     (0u)

#define MTU2_TGRB_0_D_SHIFT                     (0u)
...
#define MTU2_TCR_1_TPSC_SHIFT                   (0u)
#define MTU2_TCR_1_CKEG_SHIFT                   (3u)
#define MTU2_TCR_1_CCLR_SHIFT                   (5u)

#define MTU2_TMDR_1_MD_SHIFT                    (0u)

#define MTU2_TIOR_1_IOA_SHIFT                   (0u)
#define MTU2_TIOR_1_IOB_SHIFT                   (4u)

#define MTU2_TIER_1_TGIEA_SHIFT                 (0u)
#define MTU2_TIER_1_TGIEB_SHIFT                 (1u)
#define MTU2_TIER_1_TCIEV_SHIFT                 (4u)
#define MTU2_TIER_1_TCIEU_SHIFT                 (5u)
#define MTU2_TIER_1_TTGE_SHIFT                  (7u)

#define MTU2_TSR_1_TGFA_SHIFT                   (0u)
#define MTU2_TSR_1_TGFB_SHIFT                   (1u)
#define MTU2_TSR_1_TCFV_SHIFT                   (4u)
#define MTU2_TSR_1_TCFU_SHIFT                   (5u)
#define MTU2_TSR_1_TCFD_SHIFT                   (7u)

#define MTU2_TCNT_1_D_SHIFT                     (0u)

#define MTU2_TGRA_1_D_SHIFT                     (0u)

#define MTU2_TGRB_1_D_SHIFT                     (0u)
