...
#ifndef R_RSKRZA1H_WDT_LLD_H
#define R_RSKRZA1H_WDT_LLD_H
 ...
 * Watchdog timer WDT device on the RZA1H board.
...
/** Driver Name */
#define STDIO_WDT_RZ_LLD_DRV_NAME ("LLD SITRZA1H.WDT")
