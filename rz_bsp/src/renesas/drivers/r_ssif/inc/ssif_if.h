 ...
 * @defgroup R_SW_PKG_93_SSIF_LLD_IF SSIF Low Level Driver API
 * @brief Internal low level SSIF driver component
 *
 * @anchor R_SW_PKG_93_SSIF_LLD_IF_SUMMARY
 * @par Summary
 ...
 *
 * @anchor R_SW_PKG_93_SSIF_LLD_IF_LIMITATIONS
 * @par Known Limitations
 * @ref NONE_YET
 *
 * @anchor R_SW_PKG_93_SSIF_LLD_IF_INSTANCES
