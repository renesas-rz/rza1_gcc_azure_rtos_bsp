...
#ifndef R_DMAC_INC_R_DMAC_LLD_RZA1H_H_
#define R_DMAC_INC_R_DMAC_LLD_RZA1H_H_
...
#define R_DRV_DMAC_LLD_DRV_NAME           ("LLD RZA1H DMAC")
...
#endif  /* R_DMAC_INC_R_DMAC_LLD_RZA1H_H_ */
