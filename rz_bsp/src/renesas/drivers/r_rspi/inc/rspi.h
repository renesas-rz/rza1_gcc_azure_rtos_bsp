...
#ifndef R_SW_PKG_93_RSPI_API_H_INCLUDED
...
#define ISR_RSPI_BASE (27)

/***********************************************************************************************************************
Typedef definitions
***********************************************************************************************************************/
#define ADC_PRI_SPTI1        (ISR_RSPI_BASE + 4)       /** SPI0 transmit interrupt priority                 */
#define ADC_PRI_SPRI1        (ISR_RSPI_BASE + 2)       /** SPI0 receive interrupt priority                  */
#define ADC_PRI_SPEI1        (ISR_RSPI_BASE + 3)       /** SPI0 error interrupt priority                    */
#define ADC_PRI_SPII1        (ISR_RSPI_BASE + 1)       /** SPI0 idle interrupt priority                     */
...
#endif /* R_SW_PKG_93_RSPI_API_H_INCLUDED */
/**************************************************************************//**
 * @} (end addtogroup)
 *****************************************************************************/
