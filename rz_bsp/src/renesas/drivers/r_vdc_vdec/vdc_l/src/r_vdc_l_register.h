...
*******************************************************************************/
/**************************************************************************//**
* @file         r_vdc_l_register.h
* @version      1.00
* $Rev: 99 $
* $Date:: 2017-04-10 20:56:26 +0900#$
* @brief        RZ/A1L VDC driver register setup definitions
******************************************************************************/
...
Variable Externs
******************************************************************************/
extern const vdc_regaddr_input_ctrl_t      vdc_regaddr_input_ctrl;
extern const vdc_regaddr_scaler_t          vdc_regaddr_scaler;
extern const vdc_regaddr_img_qlty_imp_t    vdc_regaddr_img_qlty_imp;
extern const vdc_regaddr_color_matrix_t    vdc_regaddr_color_matrix[VDC_COLORMTX_NUM];
extern const vdc_regaddr_img_synthesizer_t vdc_regaddr_img_synthesizer[VDC_GR_TYPE_NUM];
extern uint32_t                     * const vdc_regaddr_clut[VDC_GR_TYPE_NUM];
extern const vdc_regaddr_output_ctrl_t     vdc_regaddr_output_ctrl;
extern const vdc_regaddr_gamma_t           vdc_regaddr_gamma;
extern const vdc_regaddr_system_ctrl_t     vdc_regaddr_system_ctrl;
