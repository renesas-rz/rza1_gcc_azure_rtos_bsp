...
#define VDC5_OFF    VDC_OFF
#define VDC5_ON     VDC_ON

#define VDC6_OFF    VDC_OFF
#define VDC6_ON     VDC_ON
...
#define VDC5_EDGE_RISING    VDC_EDGE_RISING
#define VDC5_EDGE_FALLING   VDC_EDGE_FALLING

#define VDC6_EDGE_RISING    VDC_EDGE_RISING
#define VDC6_EDGE_FALLING   VDC_EDGE_FALLING
...
#define VDC5_SIG_POL_NOT_INVERTED   VDC_SIG_POL_NOT_INVERTED
#define VDC5_SIG_POL_INVERTED       VDC_SIG_POL_INVERTED

#define VDC6_SIG_POL_NOT_INVERTED   VDC_SIG_POL_NOT_INVERTED
#define VDC6_SIG_POL_INVERTED       VDC_SIG_POL_INVERTED

/*! Scaling type ID */
typedef enum
{
    VDC_SC_TYPE_SC0 = 0,               /*!< Scaler 0 */
    VDC_SC_TYPE_SC1,                   /*!< Scaler 1 */
    VDC_SC_TYPE_OIR,                   /*!< Output image generator (OIR) */
...
typedef enum
{
    ...
    VDC_GR_TYPE_GR1,                   /*!< Graphics 1 */
    VDC_GR_TYPE_GR2,                   /*!< Graphics 2 */
    VDC_GR_TYPE_GR3,                   /*!< Graphics 3 */
    VDC_GR_TYPE_VIN,                   /*!< VIN synthesizer */
    VDC_GR_TYPE_OIR,                   /*!< Output image generator (OIR) */
...
typedef enum
{
    ...
    VDC_LAYER_ID_1_WR      = (VDC_SC_TYPE_SC1 + 0),                   /*!< Write process for layer 1 */
    VDC_LAYER_ID_OIR_WR    = (VDC_SC_TYPE_OIR + 0),                   /*!< Write process for layer OIR */
    VDC_LAYER_ID_0_RD      = (VDC_SC_TYPE_NUM + VDC_GR_TYPE_GR0),    /*!< Read process for layer 0 */
    VDC_LAYER_ID_1_RD      = (VDC_SC_TYPE_NUM + VDC_GR_TYPE_GR1),    /*!< Read process for layer 1 */
    ...
    VDC_LAYER_ID_VIN_RD    = (VDC_SC_TYPE_NUM + VDC_GR_TYPE_VIN),    /*!< VIN synthesizer */
    VDC_LAYER_ID_OIR_RD    = (VDC_SC_TYPE_NUM + VDC_GR_TYPE_OIR),    /*!< Read process for layer OIR */
...
typedef enum
{
    VDC_PANEL_ICKSEL_IMG = 0,      /*!< Divided video image clock (VIDEO_X1) */
...
typedef enum
{
    VDC_LVDS_INCLK_SEL_IMG = 0,    /*!< Video image clock (VIDEO_X1) */
...
typedef enum
{
    VDC_INPUT_SEL_VDEC     = 0,    /*!< Video decoder output signals */
...
typedef enum
{
    ...
    VDC_RES_VS_IN_SEL_SC1  = 1     /*!< Sync signal output and full-screen enable signal from scaler 1 */
} vdc_res_vs_in_sel_t;
...
typedef enum
{
    VDC_LCD_TCON_POLARITY_NOT_INVERTED = 0,    /*!< Not inverted */
    VDC_LCD_TCON_POLARITY_INVERTED     = 1     /*!< Inverted */
} vdc_lcd_tcon_polarity_t;
...
#define VDC5_LCD_TCON_PIN_NON   VDC_LCD_TCON_PIN_NON
#define VDC5_LCD_TCON_PIN_0     VDC_LCD_TCON_PIN_0
#define VDC5_LCD_TCON_PIN_1     VDC_LCD_TCON_PIN_1
#define VDC5_LCD_TCON_PIN_2     VDC_LCD_TCON_PIN_2
#define VDC5_LCD_TCON_PIN_3     VDC_LCD_TCON_PIN_3
#define VDC5_LCD_TCON_PIN_4     VDC_LCD_TCON_PIN_4
#define VDC5_LCD_TCON_PIN_5     VDC_LCD_TCON_PIN_5
#define VDC5_LCD_TCON_PIN_6     VDC_LCD_TCON_PIN_6

#define VDC6_LCD_TCON_PIN_NON   VDC_LCD_TCON_PIN_NON
#define VDC6_LCD_TCON_PIN_0     VDC_LCD_TCON_PIN_0
#define VDC6_LCD_TCON_PIN_1     VDC_LCD_TCON_PIN_1
#define VDC6_LCD_TCON_PIN_2     VDC_LCD_TCON_PIN_2
#define VDC6_LCD_TCON_PIN_3     VDC_LCD_TCON_PIN_3
#define VDC6_LCD_TCON_PIN_4     VDC_LCD_TCON_PIN_4
#define VDC6_LCD_TCON_PIN_5     VDC_LCD_TCON_PIN_5
#define VDC6_LCD_TCON_PIN_6     VDC_LCD_TCON_PIN_6
...
#define VDC5_LCD_OUTFORMAT_RGB888       VDC_LCD_OUTFORMAT_RGB888
#define VDC5_LCD_OUTFORMAT_RGB666       VDC_LCD_OUTFORMAT_RGB666
#define VDC5_LCD_OUTFORMAT_RGB565       VDC_LCD_OUTFORMAT_RGB565
#define VDC5_LCD_OUTFORMAT_SERIAL_RGB   VDC_LCD_OUTFORMAT_SERIAL_RGB

#define VDC6_LCD_OUTFORMAT_RGB888       VDC_LCD_OUTFORMAT_RGB888
#define VDC6_LCD_OUTFORMAT_RGB666       VDC_LCD_OUTFORMAT_RGB666
#define VDC6_LCD_OUTFORMAT_RGB565       VDC_LCD_OUTFORMAT_RGB565
#define VDC6_LCD_OUTFORMAT_SERIAL_RGB   VDC_LCD_OUTFORMAT_SERIAL_RGB
...
typedef enum
{
    ...
    VDC_INT_TYPE_S0_WLINE,             /*!< Write specification line signal input to scaling-down control block
                                            in scaler 0 */
    VDC_INT_TYPE_S1_VI_VSYNC,          /*!< Vsync signal input to scaler 1 */
    VDC_INT_TYPE_S1_LO_VSYNC,          /*!< Vsync signal output from scaler 1 */
    VDC_INT_TYPE_S1_VSYNCERR,          /*!< Missing Vsync signal for scaler 1 */
    VDC_INT_TYPE_S1_VFIELD,            /*!< Field end signal for recording function in scaler 1 */
    VDC_INT_TYPE_IV2_VBUFERR,          /*!< Frame buffer write overflow signal for scaler 1 */
    VDC_INT_TYPE_IV4_VBUFERR,          /*!< Frame buffer read underflow signal for graphics 1 */
    VDC_INT_TYPE_S1_WLINE,             /*!< Write specification line signal input to scaling-down control block
                                            in scaler 1 */
    VDC_INT_TYPE_OIR_VI_VSYNC,         /*!< Vsync signal input to output image generator */
    VDC_INT_TYPE_OIR_LO_VSYNC,         /*!< Vsync signal output from output image generator */
    VDC_INT_TYPE_OIR_VLINE,            /*!< Specified line signal for panel output in output image generator */
    VDC_INT_TYPE_OIR_VFIELD,           /*!< Field end signal for recording function in output image generator */
    VDC_INT_TYPE_IV7_VBUFERR,          /*!< Frame buffer write overflow signal for output image generator */
    VDC_INT_TYPE_IV8_VBUFERR,          /*!< Frame buffer read underflow signal for graphics (OIR) */
...
typedef enum
{
    ...
    VDC_GR_FLM_SEL_FLM_NUM,                /*!< Selects frame 0 (graphics display) */
    VDC_GR_FLM_SEL_DISTORTION,             /*!< Links to distortion correction */
    VDC_GR_FLM_SEL_POINTER_BUFF,           /*!< Links to pointer buffer */
    VDC_GR_FLM_SEL_NUM
} vdc_gr_flm_sel_t;
...
typedef enum
{
    ...
    VDC_COLORMTX_ADJ_1,                /*!< Image quality improver 1 (scaler 1 output) */
    VDC_COLORMTX_NUM
} vdc_colormtx_module_t;

#define VDC5_COLORMTX_IMGCNT    VDC_COLORMTX_IMGCNT
#define VDC5_COLORMTX_ADJ_0     VDC_COLORMTX_ADJ_0
#define VDC5_COLORMTX_ADJ_1     VDC_COLORMTX_ADJ_1

#define VDC6_COLORMTX_IMGCNT    VDC_COLORMTX_IMGCNT
#define VDC6_COLORMTX_ADJ_0     VDC_COLORMTX_ADJ_0
#define VDC6_COLORMTX_ADJ_1     VDC_COLORMTX_ADJ_1
...
#define VDC5_COLORMTX_GBR_GBR       VDC_COLORMTX_GBR_GBR
#define VDC5_COLORMTX_GBR_YCBCR     VDC_COLORMTX_GBR_YCBCR
#define VDC5_COLORMTX_YCBCR_GBR     VDC_COLORMTX_YCBCR_GBR
#define VDC5_COLORMTX_YCBCR_YCBCR   VDC_COLORMTX_YCBCR_YCBCR

#define VDC6_COLORMTX_GBR_GBR       VDC_COLORMTX_GBR_GBR
#define VDC6_COLORMTX_GBR_YCBCR     VDC_COLORMTX_GBR_YCBCR
#define VDC6_COLORMTX_YCBCR_GBR     VDC_COLORMTX_YCBCR_GBR
#define VDC6_COLORMTX_YCBCR_YCBCR   VDC_COLORMTX_YCBCR_YCBCR
...
typedef enum
{
    ...
    VDC_IMG_IMPRV_1,               /*!< Image quality improver 1 */
    VDC_IMG_IMPRV_NUM              /*!< The number of image quality improvers */
} vdc_imgimprv_id_t;

#define VDC5_IMG_IMPRV_0    VDC_IMG_IMPRV_0
#define VDC5_IMG_IMPRV_1    VDC_IMG_IMPRV_1

#define VDC6_IMG_IMPRV_0    VDC_IMG_IMPRV_0
#define VDC6_IMG_IMPRV_1    VDC_IMG_IMPRV_1
...
#define VDC5_LTI_MDFIL_SEL_ADJ2 VDC_LTI_MDFIL_SEL_ADJ2
#define VDC5_LTI_MDFIL_SEL_ADJ1 VDC_LTI_MDFIL_SEL_ADJ1

#define VDC6_LTI_MDFIL_SEL_ADJ2 VDC_LTI_MDFIL_SEL_ADJ2
#define VDC6_LTI_MDFIL_SEL_ADJ1 VDC_LTI_MDFIL_SEL_ADJ1
...
#define VDC5_CALIBR_ROUTE_BCG   VDC_CALIBR_ROUTE_BCG
#define VDC5_CALIBR_ROUTE_GBC   VDC_CALIBR_ROUTE_GBC

#define VDC6_CALIBR_ROUTE_BCG   VDC_CALIBR_ROUTE_BCG
#define VDC6_CALIBR_ROUTE_GBC   VDC_CALIBR_ROUTE_GBC
...
#define VDC5_PDTH_MD_TRU    VDC_PDTH_MD_TRU
#define VDC5_PDTH_MD_RDOF   VDC_PDTH_MD_RDOF
#define VDC5_PDTH_MD_2X2    VDC_PDTH_MD_2X2
#define VDC5_PDTH_MD_RAND   VDC_PDTH_MD_RAND

#define VDC6_PDTH_MD_TRU    VDC_PDTH_MD_TRU
#define VDC6_PDTH_MD_RDOF   VDC_PDTH_MD_RDOF
#define VDC6_PDTH_MD_2X2    VDC_PDTH_MD_2X2
#define VDC6_PDTH_MD_RAND   VDC_PDTH_MD_RAND
