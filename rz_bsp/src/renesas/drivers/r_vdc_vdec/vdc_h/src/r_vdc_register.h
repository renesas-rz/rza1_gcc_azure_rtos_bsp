...
* @brief        VDC driver register setup definitions
******************************************************************************/
...
Variable Externs
******************************************************************************/
extern const vdc_regaddr_input_ctrl_t      vdc_regaddr_input_ctrl[VDC_CHANNEL_NUM];
extern const vdc_regaddr_scaler_t          vdc_regaddr_scaler[VDC_CHANNEL_NUM][VDC_SC_TYPE_NUM];
extern const vdc_regaddr_img_qlty_imp_t    vdc_regaddr_img_qlty_imp[VDC_CHANNEL_NUM][VDC_IMG_IMPRV_NUM];
extern const vdc_regaddr_color_matrix_t    vdc_regaddr_color_matrix[VDC_CHANNEL_NUM][VDC_COLORMTX_NUM];
extern const vdc_regaddr_img_synthesizer_t vdc_regaddr_img_synthesizer[VDC_CHANNEL_NUM][VDC_GR_TYPE_NUM];
extern uint32_t                     * const vdc_regaddr_clut[VDC_CHANNEL_NUM][VDC_GR_TYPE_NUM];
extern const vdc_regaddr_output_ctrl_t     vdc_regaddr_output_ctrl[VDC_CHANNEL_NUM];
extern const vdc_regaddr_gamma_t           vdc_regaddr_gamma[VDC_CHANNEL_NUM];
extern const vdc_regaddr_system_ctrl_t     vdc_regaddr_system_ctrl[VDC_CHANNEL_NUM];
extern const vdc_regaddr_lvds_t            vdc_regaddr_lvds;
