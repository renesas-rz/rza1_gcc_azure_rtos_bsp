 ...
 *****************************************************************************/
/******************************************************************************
 * @headerfile     r_rskrza1h_rtc_lld.h
...
#ifndef R_RSKRZA1H_RTC_LLD_H
    #define R_RSKRZA1H_RTC_LLD_H
 ...
 * Real-Time Clock RTC device on the RZA1H board.
...
/** Driver name */
    #define STDIO_RTC_RZ_LLD_DRV_NAME ("LLD SITRZA1H.RTC")
