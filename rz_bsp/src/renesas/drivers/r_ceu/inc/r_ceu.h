...
#ifndef R_SW_PKG_93_CEU_API_H_INCLUDED
#define R_SW_PKG_93_CEU_API_H_INCLUDED
 ...
 * @param config
 * @return Error codes of the CEU driver
 */
 ...
 * @return Error codes of the CEU driver
 */
ceu_error_t R_CEU_Execute(const void * cayr, const void * cacr, const uint32_t chdw);
...
#endif /* R_SW_PKG_93_CEU_API_H_INCLUDED */
