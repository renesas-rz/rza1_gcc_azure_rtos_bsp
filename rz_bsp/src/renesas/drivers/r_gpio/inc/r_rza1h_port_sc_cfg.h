...
{
	{P4_5,	FUNCTION_MODE5,	PIN_IO},	// Pin Function : SSIWS0
	{P4_4,	FUNCTION_MODE5,	PIN_IO},	// Pin Function : SSISCK0
	{P4_6,	FUNCTION_MODE5,	PIN_INPUT},	// Pin Function : SSIRxD0
	{P4_7,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : SSITxD0
};
...
{
	{P11_6,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA1
	{P11_7,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA0
	{P11_2,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA5
	{P11_3,	FUNCTION_MODE3,	PIN_OUTPUT},	// Pin Function : LCD0_DATA4
	{P11_4,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA3
	{P11_5,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA2
	{P10_14,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA9
	{P10_15,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA8
	{P11_0,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA7
	{P11_1,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA6
	{P10_10,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA13
	{P10_9,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA14
	{P10_8,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA15
	{P10_7,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA16
	{P10_6,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA17
	{P10_5,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA18
	{P10_4,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA19
	{P10_13,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA10
	{P10_12,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA11
	{P10_11,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA12
	{P11_15,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_CLK
	{P10_3,	FUNCTION_MODE4,	PIN_OUTPUT},	// Pin Function : LCD0_DATA20
	{P10_2,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA21
	{P10_1,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA22
	{P10_0,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_DATA23
	{P11_8,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_TCON6
	{P11_11,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_TCON3
	{P11_12,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_TCON2
	{P11_9,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_TCON5
	{P11_10,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_TCON4
	{P11_13,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_TCON1
	{P11_14,	FUNCTION_MODE5,	PIN_OUTPUT},	// Pin Function : LCD0_TCON0
};
static const st_port_init_config_t GPIO_SC_INIT_vdc50 = { 0,	32,	&GPIO_SC_TABLE_vdc50[0]	};
