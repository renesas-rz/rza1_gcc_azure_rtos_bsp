...
#define R_OS_ABSTRACTION_PRV_TINY_STACK_SIZE       (200)
#define R_OS_ABSTRACTION_PRV_SMALL_STACK_SIZE      (300)
#define R_OS_ABSTRACTION_PRV_DEFAULT_STACK_SIZE    (400)
#define R_OS_ABSTRACTION_PRV_LARGE_STACK_SIZE      (500)
#define R_OS_ABSTRACTION_PRV_HUGE_STACK_SIZE       (600)
