...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_dcd_rz_buffer_empty_interrupt                   PORTABLE C      */ 
/*                                                           5.8          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
/*    Thierry Giron                                                       */ 
...
ULONG       rz_bemp_register;
    ...
    _ux_dcd_rz_register_clear(dcd_rz, UX_RZ_DCD_INTENB0, UX_RZ_DCD_INTENB0_BEMPE | UX_RZ_DCD_INTENB0_NRDYE | UX_RZ_DCD_INTENB0_BEMPE);

    /* Read the BEMP register.  */
    rz_bemp_register = _ux_dcd_rz_register_read(dcd_rz, UX_RZ_DCD_BEMPENB);

    /* Enable or Disable ?  */
    if (flag == UX_DCD_RZ_ENABLE)

        /* Set the appropriate endpoint number.  */
        rz_bemp_register |= (1 << ed -> ux_dcd_rz_ed_index);
    ...
    _ux_dcd_rz_register_write(dcd_rz, UX_RZ_DCD_BEMPENB, rz_bemp_register);
