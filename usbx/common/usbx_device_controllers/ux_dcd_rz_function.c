...
/*  FUNCTION                                                 RELEASE      */
/*                                                                        */
/*    _ux_dcd_rz_function                                   PORTABLE C    */
/*                                                             5.8        */
/*  AUTHOR                                                                */ 
/*                                                                        */ 
/*    Thierry Giron                                                       */ 
...
/*  CALLS                                                                 */ 
/*                                                                        */ 
/*    _ux_dcd_rz_endpoint_create          Create endpoint                 */
/*    _ux_dcd_rz_endpoint_destroy         Destroy endpoint                */
/*    _ux_dcd_rz_endpoint_reset           Reset endpoint                  */
/*    _ux_dcd_rz_endpoint_stall           Stall endpoint                  */
/*    _ux_dcd_rz_endpoint_status          Get endpoint status             */ 
/*    _ux_dcd_rz_frame_number_get         Get frame number                */
/*    _ux_dcd_rz_state_change             Change state                    */
/*    _ux_dcd_rz_transfer_request         Request data transfer           */
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    USBX Device Stack                                                   */ 
...
UX_DCD_RZ       *dcd_rz;
    ...
    case UX_DCD_GET_FRAME_NUMBER:
        ...
        status =  _ux_dcd_rz_frame_number_get(dcd_rz, (ULONG *) parameter);
        break;

    case UX_DCD_TRANSFER_REQUEST:

        status =  _ux_dcd_rz_transfer_request(dcd_rz, (UX_SLAVE_TRANSFER *) parameter);
        break;

    case UX_DCD_CREATE_ENDPOINT:

        status =  _ux_dcd_rz_endpoint_create(dcd_rz, parameter);
        break;
        
    case UX_DCD_DESTROY_ENDPOINT:

        status =  _ux_dcd_rz_endpoint_destroy(dcd_rz, parameter);
        break;

    case UX_DCD_RESET_ENDPOINT:

        status =  _ux_dcd_rz_endpoint_reset(dcd_rz, parameter);
        break;

    case UX_DCD_STALL_ENDPOINT:

        status =  _ux_dcd_rz_endpoint_stall(dcd_rz, parameter);
        break;
    ...
    case UX_DCD_CHANGE_STATE:
        ...
        status =  _ux_dcd_rz_state_change(dcd_rz, (ULONG) parameter);
        break;

    case UX_DCD_ENDPOINT_STATUS:

        status =  _ux_dcd_rz_endpoint_status(dcd_rz, (ULONG) parameter);
        break;
