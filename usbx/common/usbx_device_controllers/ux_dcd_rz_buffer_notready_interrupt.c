...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_dcd_rz_buffer_notready_interrupt                PORTABLE C      */ 
/*                                                           5.8          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
/*    Thierry Giron                                                       */ 
...
ULONG       rz_brdy_register;
    ...
    rz_brdy_register = _ux_dcd_rz_register_read(dcd_rz, UX_RZ_DCD_NRDYENB);
    ...
    /* Wrie the NRDY register.  */
    _ux_dcd_rz_register_write(dcd_rz, UX_RZ_DCD_NRDYENB, rz_brdy_register);
