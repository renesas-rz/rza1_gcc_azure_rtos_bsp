...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_hcd_rz_register_clear                           PORTABLE C      */ 
/*                                                           5.8          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
/*    Thierry Giron                                                       */ 
...
/*  DESCRIPTION                                                           */ 
/*                                                                        */ 
/*    This function clears flags in a register to the RZ                  */ 
/*                                                                        */ 
/*  INPUT                                                                 */ 
/*                                                                        */ 
...
VOID  _ux_hcd_rz_register_clear(UX_HCD_RZ *hcd_rz, ULONG rz_register, ULONG register_value)
{
    ...
    /* Clear a RZ USB register.  */
    *((USHORT *) rz_register) = *(USHORT *)rz_register &  ~((USHORT) register_value);
