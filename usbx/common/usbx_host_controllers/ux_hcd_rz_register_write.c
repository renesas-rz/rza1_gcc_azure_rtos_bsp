...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_hcd_rz_register_write                           PORTABLE C      */ 
/*                                                           5.8          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
/*    Thierry Giron                                                       */ 
...
/*  DESCRIPTION                                                           */ 
/*                                                                        */ 
/*    This function writes a register to the RZ.                          */ 
/*                                                                        */ 
/*  INPUT                                                                 */ 
/*                                                                        */ 
...
VOID  _ux_hcd_rz_register_write(UX_HCD_RZ *hcd_rz, ULONG rz_register, ULONG register_value)
{
    ...
    /* Write a value to a RZ USB register. */
    *((USHORT *) rz_register) = (USHORT) register_value;
