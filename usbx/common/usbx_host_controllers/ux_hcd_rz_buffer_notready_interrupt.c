...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_hcd_rz_buffer_notready_interrupt                PORTABLE C      */ 
/*                                                           5.8          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
/*    Thierry Giron                                                       */ 
...
ULONG       rz_brdy_register;
    ...
    rz_brdy_register = _ux_hcd_rz_register_read(hcd_rz, UX_RZ_HC_NRDYENB);
    ...
    _ux_hcd_rz_register_write(hcd_rz, UX_RZ_HC_NRDYENB, rz_brdy_register);
