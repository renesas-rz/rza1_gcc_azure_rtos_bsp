...
/*  Date (dd.mm.yyyy): 24.10.2020   Time (hh:mm): 10:55                        */
/*******************************************************************************/
...
static GX_STUDIO_EVENT_ENTRY gx_studio_thermostat_screen_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS thermostat_screen_event_chain = {gx_studio_thermostat_screen_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))screen_base_event_process};
static UINT gx_studio_thermostat_screen_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &thermostat_screen_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET thermostat_screen_define =
{
    ...
    gx_studio_template_create,               /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_thermostat_screen_event_process, /* event function override */
    {0, 0, 639, 479},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_lights_screen_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS lights_screen_event_chain = {gx_studio_lights_screen_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))screen_base_event_process};
static UINT gx_studio_lights_screen_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &lights_screen_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET lights_screen_define =
{
    ...
    gx_studio_template_create,               /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_lights_screen_event_process, /* event function override */
    {0, 0, 639, 479},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_locks_screen_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS locks_screen_event_chain = {gx_studio_locks_screen_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))screen_base_event_process};
static UINT gx_studio_locks_screen_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &locks_screen_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET locks_screen_define =
{
    ...
    gx_studio_template_create,               /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_locks_screen_event_process, /* event function override */
    {0, 0, 639, 479},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_win_San_Diego_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS win_San_Diego_event_chain = {gx_studio_win_San_Diego_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_win_San_Diego_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &win_San_Diego_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET win_San_Diego_define =
{
    ...
    gx_studio_template_create,               /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_win_San_Diego_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_win_New_York_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS win_New_York_event_chain = {gx_studio_win_New_York_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_win_New_York_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &win_New_York_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET win_New_York_define =
{
    ...
    gx_studio_template_create,               /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_win_New_York_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    GX_NULL,                                 /* child widget                   */
    0,                                       /* control block                  */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_win_Las_Vegas_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS win_Las_Vegas_event_chain = {gx_studio_win_Las_Vegas_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_win_Las_Vegas_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &win_Las_Vegas_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET win_Las_Vegas_define =
{
    ...
    gx_studio_template_create,               /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_win_Las_Vegas_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    GX_NULL,                                 /* child widget                   */
    0,                                       /* control block                  */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_weather_screen_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS weather_screen_event_chain = {gx_studio_weather_screen_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))screen_base_event_process};
static UINT gx_studio_weather_screen_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &weather_screen_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET weather_screen_define =
{
    ...
    gx_studio_template_create,               /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_weather_screen_event_process, /* event function override */
    {0, 0, 639, 479},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_thermostat_page_4_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS thermostat_page_4_event_chain = {gx_studio_thermostat_page_4_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_thermostat_page_4_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &thermostat_page_4_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET thermostat_page_4_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_thermostat_page_4_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_thermostat_page_3_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS thermostat_page_3_event_chain = {gx_studio_thermostat_page_3_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_thermostat_page_3_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &thermostat_page_3_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET thermostat_page_3_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_thermostat_page_3_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_thermostat_page_2_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS thermostat_page_2_event_chain = {gx_studio_thermostat_page_2_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_thermostat_page_2_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &thermostat_page_2_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET thermostat_page_2_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_thermostat_page_2_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_thermostat_page_1_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS thermostat_page_1_event_chain = {gx_studio_thermostat_page_1_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_thermostat_page_1_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &thermostat_page_1_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET thermostat_page_1_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_thermostat_page_1_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_lights_page_3_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS lights_page_3_event_chain = {gx_studio_lights_page_3_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_lights_page_3_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &lights_page_3_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET lights_page_3_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_lights_page_3_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_lights_page_2_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS lights_page_2_event_chain = {gx_studio_lights_page_2_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_lights_page_2_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &lights_page_2_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET lights_page_2_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_lights_page_2_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_lights_page_4_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS lights_page_4_event_chain = {gx_studio_lights_page_4_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_lights_page_4_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &lights_page_4_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET lights_page_4_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_lights_page_4_event_process, /* event function override */
    {100, 90, 710, 384},                     /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_lights_page_1_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS lights_page_1_event_chain = {gx_studio_lights_page_1_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_lights_page_1_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &lights_page_1_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET lights_page_1_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_lights_page_1_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_locks_page_3_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS locks_page_3_event_chain = {gx_studio_locks_page_3_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_locks_page_3_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &locks_page_3_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET locks_page_3_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_locks_page_3_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_locks_page_2_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS locks_page_2_event_chain = {gx_studio_locks_page_2_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))gx_window_event_process};
static UINT gx_studio_locks_page_2_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &locks_page_2_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET locks_page_2_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_locks_page_2_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
...
static GX_STUDIO_EVENT_ENTRY gx_studio_locks_page_1_event_table[] = {
    {0, 0, GX_NULL}
};

GX_STUDIO_EVENT_PROCESS locks_page_1_event_chain = {gx_studio_locks_page_1_event_table, (UINT (*)(GX_WIDGET *, GX_EVENT *))locks_page_1_event_process};
static UINT gx_studio_locks_page_1_event_process(GX_WIDGET *target, GX_EVENT *event_ptr)
{
    return (gx_studio_auto_event_handler(target, event_ptr, &locks_page_1_event_chain));
}
...
GX_CONST GX_STUDIO_WIDGET locks_page_1_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) gx_studio_locks_page_1_event_process, /* event function override */
    {90, 90, 700, 384},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
